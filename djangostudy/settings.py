...
SECRET_KEY = 'django-insecure-3hx-a&mfg)in(p7%x)5=tda4%o&$gyx4##6cuz9z74^iww1_lk'
...
MIDDLEWARE = [
    ...
    'studyapp.middleware.auth.AdminAuth',
    # 'studyapp.middleware.auth.UserRoleMiddleware',
]
